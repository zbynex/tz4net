#region Copyright (c) 2014 Zbigniew Babiej
...
namespace TZ4Net
{
	...
	public class ZoneInfo
	{
		...
		public ZoneInfo(string name, string dir)
		{
			...
			try 
			{
				...
				for (int i = 0; i < ruleCount; i++) 
				{
					...
					Debug.Assert(decodedChars == end - pos, "Unexpected number of decoded characters.");
		...
		public static string[] GetAllNames(string dir)
		{
            ...
            Debug.Assert(resourceSet != null, string.Format("No resources found for root name {0}.", resRootName));
